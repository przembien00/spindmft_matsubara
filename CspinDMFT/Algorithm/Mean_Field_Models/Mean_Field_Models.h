...
class MeanFieldModel
{
 ...
 public:
   ...
   virtual mvgb::CovarianceMatrixBlocks self_consistency( const CluCorrTen& environment_spin_corr ) const = 0;
...
class CorrelationReplicaModel : public MultiModel 
{
 ...
 public:
    ...
    virtual mvgb::CovarianceMatrixBlocks self_consistency( const CluCorrTen& environment_spin_corr ) const override;
};
