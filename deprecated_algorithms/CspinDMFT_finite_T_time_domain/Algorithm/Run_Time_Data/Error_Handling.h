...
void ITERATION_ERROR_MODE( const std::string mode, const std::string function_name )
{
    throw std::runtime_error( "iteration error mode \'" + mode + "\' invalid in " + function_name );
}
