...
public:
    ...
    // ...concerning the effective sample size diagnostic (importance sampling efficiency)
    Vec ess_list{};            // effective sample size  = (Sum_s Z_s)^2 / Sum_s Z_s^2
    Vec ess_relative_list{};   // ESS / num_Samples in [0, 1]
