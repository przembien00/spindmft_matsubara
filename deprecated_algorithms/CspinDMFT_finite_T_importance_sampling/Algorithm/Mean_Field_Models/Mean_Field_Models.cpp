...
std::tuple<SiteFields, CluCorrTen> CorrelationReplicaModel::self_consistency( const CluCorrTen& env_spin_corr, const SiteFields& env_spin_expvals ) const 
{
    ...
    return std::make_tuple( std::move(mf_mean), std::move(mf_CCT) );
}
