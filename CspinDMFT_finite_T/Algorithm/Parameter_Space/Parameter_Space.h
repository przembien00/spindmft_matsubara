...
public:
  ...
  CluList imported_correlations_Re_linearized{}; // hierarchy: category -> direction & time (not linearized at the cluster level)
  CluList imported_correlations_Im_linearized{}; // hierarchy: category -> direction & time (not linearized at the cluster level)
  std::vector<FieldVector> imported_spin_expvals{};
