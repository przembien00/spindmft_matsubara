...
spinmodels = ["DRF","DRF"]
configs = ["Test_1","Test_2"]
site_names_list = [['1-1','1-2','2-2'],['1-1','1-2','3-3']]
dir_names_list = [["xx","zz"],["xx","zz"],["xx","zz"]]
dir_indices_list = [[0,1],[0,1]]
...
for spinmodel,config,site_names,dir_names,dir_indices in zip(spinmodels,configs,site_names_list,dir_names_list,dir_indices_list):
    ...
    all_ref, disc_ref = id.ImportData_CspinDMFT(spinmodel,config,project="Tests",extension="Reference_Data")
    G_ref_list = [[4*gab for gab in all_ref['results']['correlation'][pc]] for pc in site_names]
    all, disc = id.ImportData_CspinDMFT(spinmodel,config,project="Tests",extension="Test_Data")
