#!/usr/bin/env python3
"""
Plot imaginary-time spin correlations from N=4 uncoupled spins beta scan.
Creates separate figures for site pairs (0,0), (0,1), (0,3),
...
DATA = os.path.join(ROOT, "Data", "Uncoupled_N4_scan")
PLOTS = os.path.join(ROOT, "Plots", "Uncoupled_N4_beta_scan")
...
def data_path(beta):
    ...
    base = f"spinmodel=ISO__config=Square_2D_N=4_NN_J=0.0_uncoupled__beta={bstr}"
    for suffix in ["", "_ETV"]:
