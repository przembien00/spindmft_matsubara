...
def ImportData( config, beta, project = "AFM", chemshift = "stag_0.001" ):
    filename = f"Data/{project}/spinmodel=ISO__config={config}__beta={beta:g}__chemshift={chemshift}.hdf5"
    return h5.File( filename, 'r' )

config = "Cubic_3D_N=2_NN_J=0.5"
beta_array = [0.2, 0.5, 1, 1.5, 3, 3.5, 4, 4.5, 5]
...
plt.savefig("Plots/Mag_AFM_N2_site0_vs_beta.pdf")
