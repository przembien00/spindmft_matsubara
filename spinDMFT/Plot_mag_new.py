...
beta_array = [round(2.5 + 0.1*i, 2) for i in range(11)]
JL = -2
h_abs = 0.001
...
for beta in beta_array:
    all = ImportData_spinDMFT("ISO",physical_data=f"JL={JL}__beta={beta:.2g}__h=z_h_abs={h_abs:.2g}",project="Magnetization_new")
...
plt.savefig("Plots/Mag_new_vs_beta.pdf")
