    ...
    m_num_TriesToBuildFile( 5 )
{
    ...
    create_file( pspace, rtdata.eigenvalue_threshold_violated );
}
...
void HDF5_Storage::store_main( const ps::ParameterSpace& pspace, rtd::RunTimeData& rtdata, CluCorrTen& CCT )
{
    ...
    hdf5r::store_2D_tensor<uint>( ps_group_id, "compute_only_categories, stored according to the hierarchy n, i-j", H5T_NATIVE_INT, pspace.compute_only_categories );
    ...
    hdf5r::store_string( ps_group_id, "imported_correlations_src_directory",    hdf5r::none_if_empty(pspace.imported_correlations_src_directory) );
    hdf5r::store_2D_tensor<uint>( ps_group_id, "import_only_categories, stored according to the hierarchy n, i-j", H5T_NATIVE_INT, pspace.import_only_categories );
    ...
    hdf5r::store_scalar( rtd_group_id, "positive_eigen_values_sum",             rtdata.positive_eigen_values_sum );
    hdf5r::store_scalar( rtd_group_id, "negative_eigen_values_sum",             rtdata.negative_eigen_values_sum );
    hdf5r::store_scalar( rtd_group_id, "largest_positive_eigen_value",          rtdata.largest_positive_eigen_value );
    hdf5r::store_scalar( rtd_group_id, "largest_negative_eigen_value",          rtdata.largest_negative_eigen_value );
    hdf5r::store_scalar( rtd_group_id, "negative_eigenvalue_ratio",             rtdata.negative_eigenvalue_ratio );
    hdf5r::store_string( rtd_group_id, "eigenvalue_threshold_violated",         hdf5r::bool_to_string(rtdata.eigenvalue_threshold_violated) );
...
void HDF5_Storage::store_time( const tmm::DerivedTimeMeasure& tmeasure )
{
    ...
    // store total duration and start date and time
