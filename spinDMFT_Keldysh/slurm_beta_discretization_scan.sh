...
#   sbatch spinDMFT_Keldysh/slurm_beta_discretization_scan.sh
#   sbatch slurm_beta_discretization_scan.sh
# To submit only a subset, for example tasks 0 through 5:
#   sbatch --array=0-5 slurm_beta_discretization_scan.sh
...
# Match the beta range of slurm_beta_sample_scan.sh.  The existing
...
project=Keldysh_stype_C_hz0.5_discretization
